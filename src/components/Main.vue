...
<div class="main h-100 bg-dark_black  text-2xl mt-12 pt-12 lg:p-3">
    <div class="box flex items-center justify-center h-12  bg-secondary text-2xl text-white mt-5 py-1  mx-5 my-5  rounded-md p-4">
